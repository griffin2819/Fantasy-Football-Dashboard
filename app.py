...
st.markdown("""
<style>
/* V7.53 unified Fantasy Edge shell — presentation only */
...
/* Metrics become compact cards everywhere */
div[data-testid="stMetric"]{background:linear-gradient(145deg,rgba(31,38,49,.97),rgba(21,27,36,.97));border:1px solid var(--fe-border);border-radius:16px;padding:.82rem .9rem;box-shadow:0 8px 22px rgba(0,0,0,.11);}
div[data-testid="stMetricLabel"]{color:var(--fe-muted)!important;} div[data-testid="stMetricValue"]{font-weight:780!important;letter-spacing:-.03em!important;}
/* Data surfaces */
...
@media(max-width:700px){.block-container{padding-left:1rem!important;padding-right:1rem!important;padding-top:.9rem!important;}button[data-baseweb="tab"]{padding:0 .7rem!important;font-size:.88rem!important;}h1{font-size:2rem!important;}h2{font-size:1.65rem!important;}h3{font-size:1.35rem!important;}div[data-testid="stMetric"]{padding:.7rem .7rem;}}
</style>
...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        .fe-stat-card{{background:linear-gradient(145deg,rgba(31,38,49,.96),rgba(21,27,36,.96));border:1px solid rgba(148,163,184,.20);border-radius:16px;padding:.85rem .9rem;min-height:94px;box-shadow:0 8px 22px rgba(0,0,0,.12);}}
        .fe-stat-label{{font-size:.82rem;color:#aeb6c2;margin-bottom:.38rem;line-height:1.15;}}
        .fe-stat-value{{font-size:1.65rem;font-weight:760;color:#f8fafc;line-height:1.05;letter-spacing:-.025em;}}
        ...
        @media(max-width:640px){{.fe-stat-grid{{gap:.45rem}}.fe-stat-card{{padding:.7rem .65rem;min-height:82px}}.fe-stat-label{{font-size:.72rem}}.fe-stat-value{{font-size:1.35rem}}.fe-rec-title{{font-size:1.5rem}}}}
        </style>
