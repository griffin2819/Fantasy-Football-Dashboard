...
st.set_page_config(page_title="Fantasy Edge v9.40 — Exact League Construction", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.40 — Exact League Construction + Unified Recommendation")
st.caption("v9.38 • v9.08 certified engine • unified Draft/Mock player universe • 12-team snake • DB/DL IDP ingestion")
st.caption("Build ID: FE-V9.40-EVIDENCE-IDP-AUTHORITY-20260820")
...
with tabs[2]:
    ...
    st.success("🔒 v9.40 SAME Draft/Mock scoring • 🧠 evidence-authoritative IDP • 🐍 12-team snake")
