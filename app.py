...
st.set_page_config(page_title=f"Fantasy Edge V{APP_VERSION} — Always-On Diagnostics", page_icon="🏈", layout="wide")
st.markdown("""
<style>
        ...
        if _my_roster.empty:
            ...
            if _moves_df.empty:
                ...
                if not _waiver_data_ready:
                    ...
                    _simple=_best[["Add","Pos","Drop","Waiver Call","FAAB"]].copy().head(12)
                    _simple=_simple.rename(columns={"Waiver Call":"Model","FAAB":"FAAB / Claim"})
