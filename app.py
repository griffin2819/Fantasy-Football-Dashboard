...
_v777_page=st.radio("Fantasy Edge navigation",_V777_PAGES,horizontal=True,key="_v777_page",label_visibility="collapsed")
_v777_page_idx=_V777_PAGES.index(_v777_page)
st.markdown("""<style>
