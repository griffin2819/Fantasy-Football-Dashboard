...
# ---------------- V7.35 Early Injury News + Roster Contingency ----------------
...
def _v735_news_watch(board_df,state):
    ...
    active=my[~my.apply(_v682_verified_reserve,axis=1)].copy()
    ...
    # Also include any player already carrying an injury/practice concern.
    concern=my[my.apply(lambda r:_v682_injury_risk(r)!='LOW',axis=1)]
