...
if _refresh_live:
    ...
    with st.spinner("Refreshing weekly data once…"):
        ...
        _v802_progress.info("Refresh step 2/5: historical stats")
        try:
            hist=nfl_history()
        ...
        _v802_progress.info("Refresh step 3/5: bounded market download")
        try:
        ...
        _v802_progress.info("Refresh step 4/5: rebuilding the base model")
        ...
        _v802_progress.info("Refresh step 5/5: matchup, role, and weekly projections")
