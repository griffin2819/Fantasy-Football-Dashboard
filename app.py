...
st.set_page_config(page_title="Fantasy Edge v9.45 — Exact League + Kicker Requirement", page_icon="🏈", layout="wide")
...
st.caption("Build ID: FE-V9.45-QUALITY-AUTHORITY-IDP-20260821")
