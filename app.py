...
st.set_page_config(page_title="Fantasy Edge v9.24 — Live Draft", page_icon="🏈", layout="wide")
...
def roster_opportunity_adjustment(df, roster, round_no, current_pick, slots):
    ...
    for _,r in x.iterrows():
        ...
        # QB2 opportunity cost in standard 1-QB builds.
        if pos=="QB" and qb>=1:
            if rnd<=10:
                adj -= 12.0
        ...
        # TE2 opportunity cost after starter is filled.
        if pos=="TE" and te>=1:
            if rnd<=10:
                adj -= 8.0
                why.append("TE2 after TE1")
            else:
                adj -= 3.0
...
st.title("🏈 Fantasy Edge v9.24 — Live Draft + Roster Opportunity")
st.caption("v9.2 • v9.08 certified engine • live injury overlay")
st.caption("Build ID: FE-V9.2-INJURY-OVERLAY-20260819")
...
with tabs[1]:
    ...
    st.success("✅ v9.08 certified engine • v9.22 injury overlay • v9.24 roster opportunity cost • Mine/Opponent tracking")
...
with tabs[2]:
    ...
    st.success("🔒 v9.23.1 availability integrity active • 🧠 v9.24 roster opportunity cost active")
