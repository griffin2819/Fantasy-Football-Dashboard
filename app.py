...
with tabs[6]:
    ...
    st.caption("V7.29 Live Schedule Matchup Resolver — V7.27 Compact Decision View is FROZEN. The same approved layout remains, while urgency, roster-impact, and command-center intelligence improve underneath.")
