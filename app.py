...
def nfl_history():
    try:
        ...
        for year in years:
            ...
            try:
                part=pd.read_csv(url,low_memory=False)
...
if _refresh_live:
    ...
    with st.spinner("Refreshing weekly data once…"):
        ...
        _v802_progress.info("Refresh step 6/6: matchup, role, and weekly projections")
...
if _refresh_live:
    ...
    if _v645_projection_matches:
        ...
        st.sidebar.caption("Published projection refresh unavailable; prior/local projections retained." +
                           (f" ({_v645_projection_error})" if _v645_projection_error else ""))
else:
    _v645_projection_matches=0; _v645_projection_error="snapshot navigation"
