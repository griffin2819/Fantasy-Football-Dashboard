...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        st.caption("V7.45 contextual drop engine: roster assets use LOCKED / PROTECTED / CONDITIONAL / DROPPABLE tiers; required-position emergencies evaluate the least-damaging legal cut.")
