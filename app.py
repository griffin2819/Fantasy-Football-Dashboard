...
st.set_page_config(page_title=f"Fantasy Edge V{APP_VERSION} — Canonical Status Authority", page_icon="🏈", layout="wide")
st.markdown("""
<style>
...
with tabs[14]:
    ...
    if my.empty:
        ...
        <div class="fecc-cert"><div><b>✅ Weekly Data Certified</b><small>Fresh feeds loaded and certification rerun.</small></div><small>Week {_week756}</small></div>
        ...
        <div class="fecc-grid">
          <div class="fecc-metric"><div class="k">📊 Lineup PPG</div><div class="v">{lineup:.1f}</div><div class="s">Current optimized lineup</div></div>
