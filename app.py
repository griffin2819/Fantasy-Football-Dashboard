...
def load_v9_production():
    ...
    _cornerstones=["CeeDee Lamb","Kenneth Walker III","Justin Jefferson","Saquon Barkley",
                   ...
                   "DeVonta Smith","Bo Nix","Colston Loveland","Ladd McConkey"]
    ...
    _top100_smoke=[
        ...
        "Bo Nix","Colston Loveland","Ladd McConkey"
    ]
...
with tabs[1]:
    ...
    _pool_check=["CeeDee Lamb","Kenneth Walker III","DeVonta Smith","Bo Nix","Colston Loveland","Ladd McConkey"]
