...
def grade_mock(roster, teams, slots):
    ...
    model_edge=float(np.clip(model_edge-_portfolio_penalty-_reach_penalty,35,100))
    opp+=_portfolio_penalty+_reach_penalty
    ...
    return {"score":score,"grade":grade,"starter":starter,"value":avg_market,"penalty":max(0,100-construction),
            ...
            "big_reach_rate":_big_reach_rate,"portfolio_penalty":_portfolio_penalty}
            ...
            if owner==int(slot):
                ...
                st.dataframe(
                    top[["player","position","team","evaluation_rank","Action","Market pick",
                         "Survives to next pick","projection","vorp","usable_vorp","marginal_roster_value","value_over_next_roster_slot",
