...
st.set_page_config(page_title="Fantasy Edge V7.28 — Provisional Ramp Market Signal", page_icon="🏈", layout="wide")
    ...
    for owner in [str(i) for i in range(2,13)]:
        ...
        for _,target in targets.iterrows():
            for _,offer in offers.iterrows():
                ...
                # V7.17: realistic = helps user, respects protected assets, and is plausible for partner.
                if my_gain<=0.10:
                    continue
                _trade_ok,_trade_reason=_v717_trade_guard(offer,target,my_gain,opp_gain)
                if not _trade_ok:
                    continue
...
with tabs[6]:
    ...
    st.caption("V7.28 Weekly Decision Intelligence — V7.27 Compact Decision View is FROZEN. The same approved layout remains, while urgency, roster-impact, and command-center intelligence improve underneath.")
    ...
    if _my.empty:
        ...
        st.caption(f"Fantasy Edge V7.28 • {_v677_season} Week {_v677_week} • Same V7.26 engine, simpler decision-first report.")
