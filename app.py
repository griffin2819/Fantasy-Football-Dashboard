...
st.set_page_config(page_title="Fantasy Edge v9.37 — Exact League Construction", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.37 — Exact League Construction + Unified Recommendation")
st.caption("v9.37 • v9.08 certified engine • DB/DL fantasy-IDP ingestion + authoritative FINAL PICK")
st.caption("Build ID: FE-V9.37.1-DB-FANTASY-IDP-HEADER-FIX-20260820")
...
with tabs[2]:
    ...
    st.success("🔒 v9.37 availability integrity active • 🧠 DB/DL fantasy-IDP ingestion + exact 2-FLEX/6-bench construction + authoritative FINAL PICK active")
