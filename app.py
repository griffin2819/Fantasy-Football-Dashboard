...
st.set_page_config(page_title="Fantasy Edge v9.38.1 — Exact League Construction", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.38.1 — Exact League Construction + Unified Recommendation")
st.caption("v9.38 • v9.08 certified engine • unified Draft/Mock player universe • 12-team snake • DB/DL IDP ingestion")
st.caption("Build ID: FE-V9.38.1-FAAB-NAN-HOTFIX-20260820")
