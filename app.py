...
st.set_page_config(page_title=f"Fantasy Edge V{APP_VERSION} — Parallel Role Refresh", page_icon="🏈", layout="wide")
st.markdown("""
<style>
    ...
    with st.spinner("Refreshing weekly data once…"):
        ...
        try:
            with concurrent.futures.ThreadPoolExecutor(max_workers=3) as _v813_pool:
                ...
                _f_state=_v813_pool.submit(_v677_nfl_state)
                try:
