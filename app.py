...
st.title("🏈 Fantasy Edge V8.05 — Frozen Production Champion")
st.caption("V8.05 • frozen production champion • certified R2 + R3 + R7")
st.caption("Build ID: V8.05-FROZEN-PRODUCTION-CHAMPION-20260819")
