...
st.set_page_config(page_title="Fantasy Edge V6.37 — Consensus Rank Enrichment", page_icon="🏈", layout="wide")
...
with tabs[1]:
    ...
    if st.button("➕ Record draft pick",type="primary") and pick:
        ...
        if len(prow):
            ...
            _rr=_active_roster_export[_active_roster_export["player"].eq(pick)]
