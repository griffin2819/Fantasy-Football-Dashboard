...
st.set_page_config(page_title="Fantasy Edge v9.28.1 — Live Draft", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.28.1 — Live Draft + Impact IDP Quality")
st.caption("v9.28.1 • v9.08 certified engine • impact IDP hotfix + board integrity + roster opportunity")
st.caption("Build ID: FE-V9.28.1-IMPACT-IDP-NAMEERROR-HOTFIX-20260820")
...
with tabs[2]:
    ...
    st.success("🔒 v9.23.1 availability integrity active • 🧠 v9.28.1 impact-IDP + coordinated roster opportunity active")
    ...
    st.caption("V9.08 remains the frozen certified core; V9.28.1 applies live injury, availability, and roster-opportunity overlays without changing the frozen core.")
