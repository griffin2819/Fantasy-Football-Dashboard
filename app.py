...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        st.caption("V7.40 waiver engine: required-position emergencies now rank the full bench/stash pool instead of defaulting to one injured veteran. Confirmed multi-week reserve absences are evaluated by return horizon, while temporary same-team opportunity boosts remain active.")
        ...
        if _moves_df.empty:
            ...
            if _best.empty:
                ...
                st.dataframe(_best[["Add","Pos","Drop","Drop Pos","Drop Cost","Emergency Drop Rank","Drop Context","Priority Score","Waiver Call","FAAB","Claim Advice","Move Type","Need Fit","Evidence","Evidence Detail","Opportunity Boost","Effective Add PPG","Opportunity","Opportunity Confidence","Why Not Priority","Net Week","Net ROS","Add Role","Add Recent PPG","Add Status","Add Practice","Add Injury","Add Matchup","Drop Protection","Drop Status","Drop Practice","Drop Role","Drop Recent PPG","Add PPG","Drop PPG","Add ROS","Drop ROS","Add VORP","Drop VORP","Why"]].head(40),
                             use_container_width=True,hide_index=True)
