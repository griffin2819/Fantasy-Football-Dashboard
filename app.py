...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        st.caption("V7.49 dynamic need resolution: REQUIRED COVERAGE is reserved for true playable-lineup holes; QUESTIONABLE/news-risk starters create PREP only when no second playable option is already rostered; covered positions revert to normal upgrade-only evaluation, and playable positional floors cannot be sacrificed for luxury depth.")
