...
st.caption("v9.31 • v9.08 certified engine • IDP impact/opportunity-cost gate + authoritative FINAL PICK")
st.caption("Build ID: FE-V9.30-UNIFIED-ONESIE-IDP-GATE-20260820")
...
with tabs[2]:
    ...
    st.success("🔒 v9.23.1 availability integrity active • 🧠 v9.32 exact 2-FLEX/6-bench construction + authoritative FINAL PICK active")
