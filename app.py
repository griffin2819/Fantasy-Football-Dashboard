...
st.set_page_config(page_title="Fantasy Edge V6.94 — Consensus + Scarcity + Trade Finder", page_icon="🏈", layout="wide")
APP_DIR = Path(__file__).resolve().parent
V651_BUILD_ID = "V6.94-CONSENSUS-SCARCITY-TRADE-FINDER"
...
tabs=st.tabs(["⚙️ League Setup","🎯 Draft Mode","🧪 Mock Draft Lab","🧲 Add / Drop","🛡️ IDP Board","📈 Breakout / Regression","🏁 Start / Sit","🔎 Player Lab","📊 Accuracy Lab","🧠 IDP Intelligence","📡 External Consensus","🚨 Opportunity Detector","🕵️ League Scarcity","🔁 Trade Finder","🏠 Command Center"])
