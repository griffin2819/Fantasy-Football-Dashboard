...
st.set_page_config(page_title=f"Fantasy Edge V{APP_VERSION} — Attention Calibration Engine", page_icon="🏈", layout="wide")
st.markdown("""
<style>
...
with tabs[6]:
    ...
    if _my.empty:
        ...
        st.caption(f"Fantasy Edge V7.73 • {_v677_season} Week {_v677_week} • Decision-quality Start/Sit with authoritative availability, uncertainty-aware close calls, and separate unavailable/monitor groups.")
...
with tabs[14]:
    ...
    if my.empty:
        ...
        starters,bench,lineup=_v676_optimize_lineup(my)
        _actions=_v755_command_center(board,state)
