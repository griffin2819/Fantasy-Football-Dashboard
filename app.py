...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        st.caption("V7.46 asset-aware drop engine: emergency coverage still fills required positions, but it may not bypass roster-value protection; drop ranking now prioritizes least roster damage and explains every proposed cut.")
