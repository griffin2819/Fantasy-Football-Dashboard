...
st.set_page_config(page_title="Fantasy Edge v9.29 — Live Draft", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.29 — Live Draft + Roster Construction & Impact IDP")
st.caption("v9.29 • v9.08 certified engine • WR/RB construction + QB2 control + impact IDP")
st.caption("Build ID: FE-V9.29-ROSTER-IDP-COHERENCE-20260820")
...
with tabs[2]:
    ...
    st.success("🔒 v9.23.1 availability integrity active • 🧠 v9.29 roster construction + impact-IDP opportunity active")
