...
st.title("🏈 Fantasy Edge V7.90.1 — Round-2 Generic Adaptation Signature Audit")
st.caption("V7.90.1 • V7.67 frozen champion • Round-2 adaptation diagnostic")
st.caption("Build ID: V7.90.1-R2-GENERIC-ADAPTATION-FIX-20260818")
...
with tabs[2]:
    ...
    if mode=="Interactive mock":
        ...
        st.markdown("### 🔬 V7.90.1 — Round-2 Generic Adaptation Signature Audit")
        st.caption(
