...
def _v778_snapshot_encode(df):
    try:
        raw=df.to_json(orient="split",date_format="iso").encode("utf-8")
        return _v778_base64.b64encode(_v778_zlib.compress(raw,9)).decode("ascii")
    except Exception:
        return ""
...
def _v778_snapshot_decode(blob):
    try:
        ...
        raw=_v778_zlib.decompress(_v778_base64.b64decode(str(blob).encode("ascii")))
