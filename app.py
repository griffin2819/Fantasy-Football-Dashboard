...
st.title("🏈 Fantasy Edge V7.48.1 — Frozen TE .30 Conditional Rule Validation (Hotfix)")
st.caption("V7.48.1 • V7.24/.90 champion frozen • 55.97 conditional rule validation hotfix")
st.caption("Build ID: V7.48.1-P12TE30-GAP5597-HOTFIX-20260815")
...
with tabs[2]:
    ...
    if mode=="Interactive mock":
        ...
        if st.button("▶️ Run benchmark"):
            ...
            st.markdown("### 🔬 V7.48.1 robustness report")
        ...
        st.markdown("### 🧪 V7.48.1 champion baseline validation")
        ...
        if isinstance(iv_saved,pd.DataFrame) and len(iv_saved):
            ...
            st.markdown("### 🧪 V7.48.1 Champion Baseline Check")
