    ...
    if _my_roster.empty:
        ...
        for _,add_raw in _fa_eval.iterrows():
            ...
            for _,drop in _drop_pool.iterrows():
                ...
                _moves.append({
                    ...
                    "Need Adj":_need_adj,"Need Fit":("REQUIRED POSITION COVERAGE" if _is_emergency_move else _need_label),"Evidence":int(_evidence),
        ...
        if _moves_df.empty:
            ...
            if _best.empty:
                ...
                st.dataframe(_best[["Add","Pos","Drop","Drop Pos","Drop Cost","Emergency Drop Rank","Priority Score","Waiver Call","FAAB","Claim Advice","Move Type","Need Fit","Evidence","Evidence Detail","Opportunity Boost","Effective Add PPG","Opportunity","Opportunity Confidence","Why Not Priority","Net Week","Net ROS","Add Role","Add Recent PPG","Add Status","Add Practice","Add Injury","Add Matchup","Drop Protection","Drop Status","Drop Practice","Drop Role","Drop Recent PPG","Add PPG","Drop PPG","Add ROS","Drop ROS","Add VORP","Drop VORP","Why"]].head(40),
                             use_container_width=True,hide_index=True)
