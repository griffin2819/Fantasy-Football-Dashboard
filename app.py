...
st.set_page_config(page_title="Fantasy Edge v9.43 — Exact League + Kicker Requirement", page_icon="🏈", layout="wide")
...
with tabs[2]:
    ...
    st.success("🔒 v9.43 SAME Draft/Mock • 🦵 required K enforced • 🧠 IDP evidence + positional-quality dominance • 🐍 12-team snake")
    ...
    st.caption("V9.08 remains the frozen certified core; V9.43 applies exact 1QB/2RB/2WR/2FLEX/1K/1DL/1DB/6-bench construction, availability, injury, and impact-IDP overlays without changing the frozen core.")
