...
st.set_page_config(page_title="Fantasy Edge V6.60 — Unified Visible Availability", page_icon="🏈", layout="wide")
APP_DIR = Path(__file__).resolve().parent
V651_BUILD_ID = "V6.60-UNIFIED-VISIBLE-AVAILABILITY-401"
