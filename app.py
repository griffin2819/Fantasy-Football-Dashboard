    ...
    if _v777_page_idx==3:
        ...
        if _my_roster.empty:
            ...
            <div class="fe-stat-grid">
              ...
              <div class="fe-stat-card"><div class="fe-stat-label">Directory free agents</div><div class="fe-stat-value">{len(_fa)}</div></div>
            </div>
            """,unsafe_allow_html=True)
            ...
            _fa_eval=_fa_eval.sort_values("_v804_prefilter",ascending=False).groupby("position",sort=False).head(50).copy()
