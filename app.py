...
st.set_page_config(page_title="Fantasy Edge v9.49 — Exact League + Kicker Requirement", page_icon="🏈", layout="wide")
...
def v939_shared_candidate_rank(avail, roster, round_no, current_pick, next_pick, slots, randomness=6):
    ...
    if _off_pos.any():
        ...
        # v9.47 hard rule: a same-position player dominated in BOTH projection and VORP
        # cannot become FINAL PICK while the superior option is still available.
        x.loc[_idx,"evaluation_score"]-=1000.0
...
st.caption("Build ID: FE-V9.49-ELITE-IDP-QUOTA-20260821")
