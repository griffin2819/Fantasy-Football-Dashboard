...
def _single_authority_final(y,roster,slots,round_no,current_pick,next_pick,compute_stability=True):
    """
...
with tabs[2]:
    ...
    if mode=="Interactive mock":
        ...
        target_sims=100
        _benchmark_build="FE-V6.5.1-ROUND-CONTEXT-FIX-20260826"
