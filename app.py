...
st.set_page_config(page_title="Fantasy Edge v9.1 — Yahoo IDP", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge V8.11 — Frozen Champion Robustness Certification")
st.caption("V8.11 • V8.05 frozen champion • global robustness certification")
st.caption("Build ID: V8.11-FROZEN-CHAMPION-ROBUSTNESS-CERT-20260819")
...
with tabs[1]:
    st.subheader("Live roster-aware draft assistant — v9.1")
    st.success("✅ v9.08 certified production engine active • Mine/Opponent tracking enabled")
