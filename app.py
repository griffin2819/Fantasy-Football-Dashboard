...
st.set_page_config(page_title="Fantasy Edge v9.26 — Live Draft", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.26 — Live Draft + Roster Opportunity")
...
with tabs[1]:
    ...
    st.success("✅ v9.08 certified engine • v9.22 injury overlay • v9.26 roster opportunity cost • Mine/Opponent tracking")
...
with tabs[2]:
    ...
    st.success("🔒 v9.23.1 availability integrity active • 🧠 v9.26 QB2-corrected roster opportunity active")
