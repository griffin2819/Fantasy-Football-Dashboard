...
st.set_page_config(page_title=f"Fantasy Edge V{APP_VERSION} — Live Availability Authority", page_icon="🏈", layout="wide")
st.markdown("""
<style>
...
with tabs[6]:
    ...
    if _my.empty:
        ...
        # V7.67: unavailable rostered players are shown separately and can never be
        # mistaken for a start/sit recommendation.
        _unavailable_codes={"OUT","IR","PUP","NFI","SUSPENDED","DO NOT DRAFT"}
        _unavailable_rows=_my[_my.apply(lambda r:_v677_normalize_injury_status(r.get("fe_status",r.get("injury_effective",r.get("injury","ACTIVE")))) in _unavailable_codes,axis=1)].copy()
