...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        st.caption("V7.37 waiver guard: reserve protection is retained, and waiver moves now account for the opportunity cost of the player being cut. Starters/high-market assets cannot be sacrificed for stash or covered-position luxury adds without a clear lineup or major ROS gain.")
