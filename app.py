...
st.set_page_config(page_title="Fantasy Edge V6.56 — Canonical Drafted-Player Filter", page_icon="🏈", layout="wide")
APP_DIR = Path(__file__).resolve().parent
V651_BUILD_ID = "V6.56-CANONICAL-DRAFTED-FILTER-395"
