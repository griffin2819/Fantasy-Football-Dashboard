...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        st.caption("V7.44 role-confidence engine: external projections are incorporated after merge; observed usage remains distinct; every waiver HOLD exposes the nearest rejection or filtering stage.")
        ...
        if _moves_df.empty:
            ...
            if _hold_candidates:
                ...
                _reason=("No unprotected drop candidates remain after roster-asset protection." if len(_eligible_drops)==0 else "No legal add/drop pair reached transaction scoring after candidate filtering.")
