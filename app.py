...
st.set_page_config(page_title="Fantasy Edge v9.41 — Exact League Construction", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.41 — Exact League Construction + Unified Recommendation")
...
with tabs[2]:
    ...
    st.success("🔒 v9.41 SAME Draft/Mock • 🧠 IDP evidence + positional-quality dominance • 🐍 12-team snake")
