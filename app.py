...
with tabs[1]:
    ...
    if len(_active_roster_export):
        ...
        st.caption(f"Roster sync added {_depth_added} active NFL players as selectable DEPTH_ONLY entries. They cannot become DRAFT NOW from placeholder values alone.")
