...
st.set_page_config(page_title="Fantasy Edge v9.31 — Live Draft", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.31 — Live Draft + Unified Recommendation")
...
with tabs[2]:
    ...
    st.success("🔒 v9.23.1 availability integrity active • 🧠 v9.31 authoritative FINAL PICK + IDP opportunity gate active")
