...
st.set_page_config(page_title="Fantasy Edge v9.27 — Live Draft", page_icon="🏈", layout="wide")
...
def roster_opportunity_adjustment(df, roster, round_no, current_pick, slots):
    ...
    for _,r in x.iterrows():
        ...
        # v9.27 coordinated QB2/TE2 bench opportunity cost.
        # TE2 should not consume a middle-round bench pick while WR/RB flex depth is thin.
        ...
        # v9.27 adds a coordinated depth surcharge to QB2 on top of v9.26.
        # This remains a soft penalty, so a truly exceptional QB faller can still win.
        if pos=="QB" and qb>=1 and offense_depth_thin:
            if rnd<=12:
                adj -= 6.0
                why.append("QB2 vs unfinished WR/RB depth")
            elif rnd<=14:
                adj -= 3.0
                why.append("QB2 late depth cost")
        ...
        # v9.27: a second defensive player is optional depth, not a target by itself.
        # Permit IDP2 naturally late when offensive depth is healthy; discourage it otherwise.
        idp_count=dl+db
...
st.title("🏈 Fantasy Edge v9.27 — Live Draft + Coordinated Bench Opportunity")
st.caption("v9.27 • v9.08 certified engine • injury + availability + coordinated roster opportunity")
st.caption("Build ID: FE-V9.27-BENCH-OPPORTUNITY-COST-20260820")
...
with tabs[1]:
    ...
    st.success("✅ v9.08 certified engine • v9.22 injury overlay • v9.27 coordinated roster opportunity cost • Mine/Opponent tracking")
...
with tabs[2]:
    ...
    st.success("🔒 v9.23.1 availability integrity active • 🧠 v9.27 coordinated QB2/TE2 + conditional IDP2 opportunity active")
