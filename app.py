...
def prepare_user_draft_candidates(avail, roster, round_no, current_pick, slot, teams, slots, randomness):
    ...
    # Once RB5 is already rostered, prefer a genuine impact defender over RB6 depth.
    # This remains active until the roster reaches the 4-IDP cap.
    if _rb>=5:
        ...
        if _total_idp<4:
            ...
            if _impact_idp.any():
                x.loc[_impact_idp,"_construction_bonus"]+=16.0
...
with tabs[1]:
    ...
    st.dataframe(
        ...
        .rename(columns={
            ...
            "idp_external_rank":"IDP rank","idp_impact_score":"IDP impact","usable_vorp":"Usable VORP","marginal_roster_value":"Marginal roster value","idp_available_rank":"Available IDP rank","idp_available_score":"Available IDP score","roster_opportunity_adj":"Roster opp."
        }).head(120),
        use_container_width=True,hide_index=True
    )
            ...
            if owner==int(slot):
                ...
                st.dataframe(
                    top[["player","position","team","evaluation_rank","Action","Market pick",
                         "Survives to next pick","projection","vorp","usable_vorp","marginal_roster_value","idp_available_rank","idp_available_score",
