...
st.set_page_config(page_title=f"Fantasy Edge V{APP_VERSION} — Shared Certified Snapshot", page_icon="🏈", layout="wide")
st.markdown("""
<style>
...
# Save the fully canonicalized board after refresh, not the pre-intelligence board.
if _refresh_live:
    try:
