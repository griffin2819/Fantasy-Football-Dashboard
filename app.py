...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        st.caption("V7.51 simplified waiver engine — Fantasy Edge evaluates roster need, injuries/news, role, matchup, projections and drop value in the background; the main screen shows only the final model decision.")
        ...
        if _moves_df.empty:
            ...
            if _best.empty:
                st.success("🛡️ HOLD — No roster move recommended.")
            else:
        ...
        st.caption("Fantasy Edge evaluates waiver moves automatically. Recommendations are advisory and do not execute roster transactions.")
