...
APP_VERSION = "7.42"
V651_BUILD_ID = "V7.42-UNIFIED-CONTINGENCY-ENGINE"
...
with tabs[3]:
    ...
    if _my_roster.empty:
        ...
        st.caption("V7.42 unified contingency engine: official status stays authoritative, credible breaking news can trigger provisional required-position preparation, and every surface reuses the same ranked add/drop transaction.")
