...
st.set_page_config(page_title=f"Fantasy Edge V{APP_VERSION} — Availability Summary Cleanup", page_icon="🏈", layout="wide")
st.markdown("""
<style>
...
with tabs[6]:
    ...
    if _my.empty:
        ...
        st.caption("Only players eligible to play this week can appear in the optimized lineup. Current live OUT/IR/PUP/NFI/SUSPENDED designations are hard-excluded before projections are compared.")
        if _decision_rows:
        ...
        st.caption(f"Fantasy Edge V7.72 • {_v677_season} Week {_v677_week} • Availability-aware Start/Sit with separate unavailable and monitor groups.")
