...
st.set_page_config(page_title="Fantasy Edge v9.1 — Live Draft", page_icon="🏈", layout="wide")
...
st.title("🏈 Fantasy Edge v9.1 — Live Draft Production Engine")
st.caption("v9.1 • v9.08 certified engine • live draft production")
st.caption("Build ID: FE-V9.1-PRODUCTION-20260819")
