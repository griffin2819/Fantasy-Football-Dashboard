...
def _single_authority_final(y,roster,slots,current_pick,next_pick,compute_stability=True):
    """
...
with tabs[2]:
    ...
    if mode=="Interactive mock":
        ...
        target_sims=100
        _benchmark_build="FE-PREFLIGHT-V4-FAST-20260825"
        ...
        if run:
            ...
            _workers=max(1,min(2,this_batch))
            _finished=[]
            _errors=[]
