...
with tabs[13]:
    st.subheader("🔁 V7.32 Fast Trade Intelligence")
    st.caption(
        "Only recommends trades that improve your optimized roster. V7.32 adds a fast shortlist so the page loads quickly before the legal-lineup optimizer evaluates the best 1-for-1 and 2-for-1 paths."
    )
