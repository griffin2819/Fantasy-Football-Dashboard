...
st.title("🏈 Fantasy Edge V7.5 — Robustness + Realism")
st.caption("V7.5 • injury availability • IDP market normalization • uncertainty-aware robustness • frozen projections + grading")
st.caption("Build ID: V7.5-RR-20260813")
...
with tabs[2]:
    ...
    if mode=="Interactive mock":
        ...
        if st.button("▶️ Run benchmark"):
            ...
            st.markdown("### 🔬 V7.5 robustness report")
            ...
            st.download_button("⬇️ Download V7.5 diagnostic CSV",csv,"fantasy_edge_v7_5_diagnostics.csv","text/csv")
