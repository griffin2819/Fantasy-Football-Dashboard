...
st.set_page_config(page_title="Fantasy Edge v9.44.2 — Exact League + Kicker Requirement", page_icon="🏈", layout="wide")
...
st.caption("Build ID: FE-V9.44.2-MOCK-COMMIT-BACKTEST-20260821")
