...
st.set_page_config(page_title="Fantasy Edge v9.44.1 — Exact League + Kicker Requirement", page_icon="🏈", layout="wide")
...
st.caption("Build ID: FE-V9.44.1-17ROUND-STATE-FIX-20260821")
...
with tabs[2]:
    ...
    st.success("🔒 v9.44.1 SAME Draft/Mock • TE + K required • 🧠 honest IDP-relative metrics • 🐍 12-team, 17-round snake")
    ...
    st.caption("V9.08 remains the frozen certified core; V9.44.1 applies exact 1QB/2RB/2WR/1TE/2FLEX/1K/1DL/1DB/6-bench construction (17 rounds), availability, injury, and impact-IDP overlays without changing the frozen core.")
