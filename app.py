...
st.set_page_config(page_title=f"Fantasy Edge V{APP_VERSION} — Fast Snapshot Load", page_icon="🏈", layout="wide")
st.markdown("""
<style>
...
if not st.session_state.get("_v777_cloud_reconciled",False):
    try:
        _row=_cloud_probe()
...
_v803_startup.caption("Opening fast weekly snapshot…")
